...

{
  grafanaDashboards+:: {
    'apache-druid.json':
      ...
      .addPanels(
        [
          totalQueryCountPanel { gridPos: { h: 6, w: 12, x: 0, y: 0 } },
          sqlQueryCountPanel { gridPos: { h: 6, w: 12, x: 12, y: 0 } },
          successfulQueryCountPanel { gridPos: { h: 6, w: 12, x: 0, y: 6 } },
          averageSQLQueryResponseTimePanel { gridPos: { h: 6, w: 12, x: 12, y: 6 } },
          failedQueryCountPanel { gridPos: { h: 6, w: 12, x: 0, y: 12 } },
          averageSQLQueryResponseBytesPanel { gridPos: { h: 6, w: 12, x: 12, y: 12 } },
          interruptedQueryCountPanel { gridPos: { h: 6, w: 12, x: 0, y: 18 } },
          sqlQueryDataSourcesPanel { gridPos: { h: 6, w: 12, x: 12, y: 18 } },
          timedoutQueryCountPanel { gridPos: { h: 6, w: 12, x: 0, y: 24 } },
        ]
      ),
  },
}
