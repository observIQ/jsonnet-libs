        ...
        groups+: [
            {
                ...
                rules: [
                    ...
                    },
                    {
                        ...
                        expr: |||
                            sum without (description,instance,job,platform) (ibmmq_queue_oldest_message_age) >= %(alertsStaleMessages)s
                        ||| % $._config,
                        'for': '5m',
                        labels: {
                            severity: 'warning',
                        ...
                        annotations: {
                            ...
                            description: 
                                (
                                    'A stale message with an age of {{$labels.value}} has been sitting in the {{$labels.queue}} which is above the threshold of %(alertsStaleMessages)ss.'
                                ) % $._config,
                        },
                    },
                    {
